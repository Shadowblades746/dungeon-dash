...
namespace _Scripts
{
    public class StrengthPotionAI : MonoBehaviour
    {
        public float strength = 10f; // health value of the player
        ...
        private void OnCollisionEnter2D(Collision2D other) // method used to check for collisions
        {
            ...
            {
                other.gameObject.GetComponent<PlayerLogic>().StrengthPotion(); // heals the player
